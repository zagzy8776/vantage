  ...
  for (const job of jobs) {
    ...
    await db.execute(sql`
      ...
      ON CONFLICT (provider, provider_job_id, owner_id) DO UPDATE SET
        ...
        requirements = EXCLUDED.requirements, job_intelligence = COALESCE(EXCLUDED.job_intelligence, jobs.job_intelligence), verification_status = EXCLUDED.verification_status, verification_score = EXCLUDED.verification_score,
